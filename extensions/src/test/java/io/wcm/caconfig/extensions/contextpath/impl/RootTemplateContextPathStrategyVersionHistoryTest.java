...
public class RootTemplateContextPathStrategyVersionHistoryTest extends RootTemplateContextPathStrategyTest {
  ...
  public void setUp() {
    ...
    level2 = context.create().page(Path.VERSION_HISTORY + "/user1/region1/site1", TEMPLATE_1).adaptTo(Resource.class);
    level3 = context.create().page(Path.VERSION_HISTORY + "/user1/region1/site1/en", TEMPLATE_2).adaptTo(Resource.class);
